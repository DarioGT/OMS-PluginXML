...
public final class SaveDiagramDialog extends JDialog {
    ...
    private/* JLabel */JTextField browseTextField = new /* JLabel() */JTextField();
    ...
    private static final String kOK = LocaleMgr.screen.getString("Ok"); // NOT
    // LOCALIZABLE,
    // key
    ...
    private static String jpegDiagDir;
    ...
    void jbInit() throws DbException {
        ...
        pageOptionPanel.add(pageRadioButton, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 36, 11, 0), 0, 0));

        pageOptionPanel.add(fromLabel, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 11, 0), 0, 0));
        pageOptionPanel.add(fromTextField, new GridBagConstraints(2, 3, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 6, 11, 0), -20, 0));
        pageOptionPanel.add(toLabel, new GridBagConstraints(3, 3, 1, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 6, 11, 0), 0, 0));
        pageOptionPanel
                .add(toTextField, new GridBagConstraints(4, 3, 1, 1, 0.0, 0.0,
                        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 6, 11, 11),
                        -20, 0));
        ...
        pageOptionPanel.add(scaleComboBox, new GridBagConstraints(1, 4, 5, 1, 0.0, 0.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(6, 0, 3, 0), -50, 0));
    ...
    private void browse() {
        ...
        JFileChooser chooser = new JFileChooser(jpegDiagDir);
        chooser.addChoosableFileFilter(ExtensionFileFilter.jpgFileFilter);
        chooser.setFileFilter(ExtensionFileFilter.jpgFileFilter);
        chooser.setDialogTitle(kExportToJPEG);
        ...
        if (file.getName().lastIndexOf('.') == file.getName().lastIndexOf(".\\")) // or "./"
            browseTextField.setText(file.getPath() + "."
                    + ExtensionFileFilter.jpgFileFilter.getExtension()); // NOT
        // LOCALIZABLE
        else
            browseTextField.setText(file.getPath());

        jpegDiagDir = chooser.getCurrentDirectory().toString();
        setSaveDiagDir(jpegDiagDir);
    ...
    private void launchTask() {
        ...
        c.start(new SaveDiagramWorker(new SaveDiagramOptions(this, objects)));
        setVisible(false);
    }
    ...
    private File validateFile(String fileName) throws CancelledOperationException {
        ...
        if (!file.isAbsolute())
            file = new File(jpegDiagDir, fileName);
