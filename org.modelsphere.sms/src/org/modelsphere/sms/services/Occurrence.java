...
public final class Occurrence extends AbstractOccurrence {
    ...
    private static org.modelsphere.jack.baseDb.db.DbSemanticalObject findSemanticalObject(
        ...
        org.modelsphere.jack.baseDb.db.Db currentDb = null; // TD--:Db.getSingleton();
        java.lang.reflect.Method m = getMethod("db.Db", "getMetaClass" + aSuperTypeName,
                new String[] {}); // NOT LOCALIZABLE
        // try {
        // TD--: mc = (MetaClass)m.invoke(currentDb, new String[] {});
        java.util.Enumeration enumeration = null; // TD--:mc.getInstances();
    ...
    public static void startTransaction(String transactionName) {
        // TD--:Db.getSingleton().startTransaction(transactionName);
    }

    public static void commitTransaction() {
        // TD--:Db.getSingleton().commit();
    }
    ...
    private void setFields(org.modelsphere.jack.baseDb.db.DbSemanticalObject newOccurrence) {
         ...
         * (org.modelsphere.sms.oo.db.DbDataMember)newOccurrence; // TD--:field.setStatiC(true);
         * 
    ...
    public void create() {
        ...
        if (m_superName == null) {
            m_superObj = null; // TD--:db.getCurrentProject();
        } else {
