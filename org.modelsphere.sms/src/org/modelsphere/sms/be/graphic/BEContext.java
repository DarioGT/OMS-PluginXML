...
public class BEContext extends GraphicNode implements ActionInformation {
     ...
     * zoneDisplay.getMetaField().equals(DbBEUseCaseResource.fResource)) // TD-- pour ressource cas
     * spécifique!!!!!! continue;
     * 
     ...
     * // TD-- pour l'utilisation pour les enum... zone.addRow(); Object value =
    ...
    private void populateZones() {
         ...
         * try {
         * 
         * // TD--.. centerZone.addRow(); centerZone.addRow(); centerZone.addRow();
         * 
