...
public final class ForeignKey {
    ...
    public final void generate(DbORDataModel model, String actionName, int copyFlags,
        ...
        cleanup();
        StringBuffer report = buildReport();
        ...
        if (report == null)
            ...
            TextViewerDialog.showTextDialog(ApplicationContext.getDefaultMainFrame(), actionName,
                    report.toString());
    }
    ...
    private void genForeign(DbORAssociationEnd assocEnd) throws DbException {
        ...
        DbORForeign foreignKey = assocEnd.getMember();
        if (foreignKey == null)
            foreignKey = addForeignKey(assocEnd);
        else
        ...
        for (i = 0; i < sourceCols.size(); i++) {
            DbORColumn sourceCol = (DbORColumn) sourceCols.elementAt(i);
    ...
    private DbORForeign addForeignKey(DbORAssociationEnd assocEnd) throws DbException {
        try {
            ...
            foreignKey.setName(foreignKeyNameComputation(assocEnd));
    ...
    private DbORFKeyColumn addForeignCol(DbORForeign foreignKey, DbORColumn sourceCol, int i)
        ...
        setNameOfForeignColumn(sourceCol, foreignCol);
    ...
    //[Marco Savard]
    private void setNameOfForeignColumn(DbORColumn sourceCol, DbORColumn foreignCol)
            throws DbException {
        ...
        if ((sourceName != null) && (parentName != null)) {
            String foreignColumnName = parentName + " " + sourceName;
        ...
        if ((sourceName != null) && (parentName != null)) {
            String foreignColumnName = parentName + "_" + sourceName;
    ...
    private StringBuffer buildReport() throws DbException {
