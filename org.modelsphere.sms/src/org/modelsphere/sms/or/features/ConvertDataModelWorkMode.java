            ...
            if (m_absorptionToDo) {
                ...
                while (goEnum.hasMoreElements()) {
                    ...
                    if (arcsGOList.size() == 2) {
                         ...
                         * TD-- m/thode dans OrAssociationTool pour traiter les polygones des 2 arcs
                ...
                //TD--  la navigabilité est défini par défaut. On devrait assigner celle des arcs           
                //orAssociation.setIsIdentifying()TD-- assigner la bonne multiplicité
