...
public class ORSpecializationTool extends LineTool {
    ...
    public ORSpecializationTool(String text, Image image, int category) {
        super(0, text, new String[] { text }, image, new Image[] { image });
    ...
    protected Cursor loadDefaultCursor() {
        ...
        Cursor cursor = AwtUtil.createCursor(image, new Point(8, 8),
                "box", true); // NOT LOCALIZABLE, not yet
        return cursor;
    }
    ...
    */
    ...
    // and return it
    //
    //TD-- : compute right-angle polylines if variable rightAngle is true
