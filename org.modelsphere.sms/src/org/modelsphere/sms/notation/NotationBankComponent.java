...
public class NotationBankComponent extends JPanel implements DbRefreshListener,
    ...
    private static final String NEW_NOTATION = LocaleMgr.misc.getString("newNotation"); //TD--: should be set in DbORNotation
    ...
    private void newbtn_actionPerformed(ActionEvent e) {
        try {
            ...
            newNotation.set(DbSMSNotation.fName, NEW_NOTATION); //TD--: Move
            // this value in
            // init default
            // value of
            // DbSMSNotation
