...
import org.modelsphere.jack.srtool.actions.SQLShellAction;
...
public class MainFrameMenu extends org.modelsphere.jack.srtool.MainFrameMenu {
    ...
    public JackMenu createDefaultToolMenu() {
        ...
        PluginAction sqlshellAction = createPluginAction("org.modelsphere.sms.plugins.sqlshell.SQLShellActivatorPlugin"); // NOT LOCALIZABLE
        if (sqlshellAction != null)
            tempObjects.add(sqlshellAction);
        tempObjects.add(null); // separator
        tempObjects.add(SMSActionsStore.getSingleton().getAction(
    ...
    private JackMenu createDefaultDebugMenu() {
        ...
        actionVector.add(null);
        actionVector.add(SQLShellAction.getSingleton());
        actionVector.add(null);
        ...
        SQLShellAction.getSingleton().setEnabled(false);
