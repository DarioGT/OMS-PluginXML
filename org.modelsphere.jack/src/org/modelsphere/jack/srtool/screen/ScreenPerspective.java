...
public class ScreenPerspective {
    public enum Perspective { FULL_VERSION, DATA_MODEL_VIEWER }
    
    //CHANGE CURRENT PERSPECTIVE HERE
    protected static Perspective _perspective = Perspective.FULL_VERSION; 
    
    public static boolean isFullVersion() {
        return _perspective == Perspective.FULL_VERSION;
    }
