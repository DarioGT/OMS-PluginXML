...
public class LayoutDialogDataOperator {
    public static final String kLayoutAll = LocaleMgr.action.getString("layoutAll");
    public static final String kLayoutSelection = LocaleMgr.action.getString("layoutSelection");
    ...
    public static void layoutExecutor(boolean growWidth, boolean growHeight, boolean randomize,
        ...
        diagram.getDiagramGO().getDb().beginWriteTrans(
                selectionOnly ? kLayoutSelection : kLayoutAll);
        ...
        //TD-- we should check the expands options and expands the drawing area in that case if it is permitted by the user.
